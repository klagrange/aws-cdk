...
export interface SplitAtListener_ServiceStackProps extends cdk.StackProps {
  ...
  autoMlEcr: ecr.Repository;
  lbListener: elbv2.ApplicationListener;
}

export class AutoMlStack extends cdk.Stack {
    constructor(scope: cdk.Construct, id: string, props: SplitAtListener_ServiceStackProps) {
      ...
      const container = taskDefinition.addContainer('automl', {
        image: ecs.ContainerImage.fromEcrRepository(props.autoMlEcr, 'latest'),
        memoryLimitMiB: 512,
      });
